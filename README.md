...
- High-priority process and domain direct routing for WeChat/Tencent login, messaging, avatar, and media CDN traffic, before ad and global service rules; related domains return real IPs instead of Fake-IP addresses for stable long-lived sessions.
